...
function submit()
{
	...
	var express =  '/home/asion/desktop/sh/shareconfig ' + '\'' + strSubmitRes + '\'';
	console.log(express);
...
var getDomainUserList = function(){
	var expr = "/home/asion/desktop/sh/ldap user";
...
var getDomainGroupList = function(){
	var expr = "/home/asion/desktop/sh/ldap group";
...
$(document).ready(function(){
	document.getElementById('filepath').innerHTML=  gui.App.argv[0];
	getDomainUserList();
	getDomainGroupList();
